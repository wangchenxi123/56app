function iframePay(cfg) {
	...
	this.createBack = function(onclose) {
		...
		acBack.id = 'iframeBackBtn'
		acBack.setAttribute('data-iframebox', this.iframeBox);
		acBack.setAttribute('data-maskid', this.maskid);
		acBack.style.cssText = "width:70px; height:30px;line-height: 30px;text-align:center;font-size:12px;color:#fff;background-color:rgba(0,0,0,0.4);position:fixed;border-radius:4px;left:10px;bottom:20%;fontFamily:Microsoft YaHei";
