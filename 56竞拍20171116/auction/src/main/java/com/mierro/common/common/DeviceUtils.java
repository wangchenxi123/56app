...
public class DeviceUtils {
     ...
     * @return
     */
    public static LoginEquipment judgmentEquipment(HttpServletRequest request) {
        LoginEquipment isMobile;
        String userAgent = request.getHeader("user-agent");
        if(userAgent.contains("iPhone")){
            isMobile = LoginEquipment.IPHONE;
        }else if(userAgent.contains("Android")){
            isMobile = LoginEquipment.ANDROID;
        }else if(userAgent.contains("iPod")){
            isMobile = LoginEquipment.IPOD;
        }else if(userAgent.contains("iPad")){
            isMobile = LoginEquipment.IPAD;
        }else if(userAgent.contains("Windows Phone")){
            isMobile = LoginEquipment.WINDOWS_PHONE;
        }else if(userAgent.contains("MQQBrowser")){
            isMobile = LoginEquipment.MOBILE_ORDER;//QQ浏览器的，无法识别
        }else if(userAgent.contains("SymbianOS")){
            isMobile = LoginEquipment.SYMBIANOS;
        }else if(userAgent.contains("Windows NT") || userAgent.contains("Windows") || userAgent.contains("compatible")){
            isMobile = LoginEquipment.WINDOWS;
        }else if(userAgent.contains("macintosh")){
            isMobile = LoginEquipment.MAC;
        }else if(userAgent.contains("Macintosh")){
            isMobile = LoginEquipment.MAC;
        }else if(userAgent.contains("Linux")){
            isMobile = LoginEquipment.LINUX;
        }else{
            isMobile = LoginEquipment.OTHER;
        }
        return isMobile;
    }
